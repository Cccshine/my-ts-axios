...
describe('defaults', () => {
  ...
  test('should transform request json', () => {
    expect((axios.defaults.transformRequest as AxiosTransformer)({ foo: 'bar' })).toBe(
      '{"foo":"bar"}'
    )
  })
  test('should do nothing to request string', () => {
    expect((axios.defaults.transformRequest as AxiosTransformer)('foo=bar')).toBe('foo=bar')
  })

  test('should transform response json', () => {
    const data = (axios.defaults.transformResponse as AxiosTransformer)('{"foo":"bar"}')
  ...
  test('should do nothing to response string', () => {
    expect((axios.defaults.transformResponse as AxiosTransformer)('foo=bar')).toBe('foo=bar')
  })
